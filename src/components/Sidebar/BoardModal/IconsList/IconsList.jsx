...
const icons = [
  { iconName: 'icon_1', svg: `${icon}#icon-blitz` },
  { iconName: 'icon_2', svg: `${icon}#icon-colors` },
  { iconName: 'icon_3', svg: `${icon}#icon-container` },
  { iconName: 'icon_4', svg: `${icon}#icon-puzzle` },
  { iconName: 'icon_5', svg: `${icon}#icon-star` },
  { iconName: 'icon_6', svg: `${icon}#icon-loading` },
  { iconName: 'icon_7', svg: `${icon}#icon-glocke` },
  { iconName: 'icon_8', svg: `${icon}#icon-hexagon` },
];

const IconsList = ({ selectedIcon, setSelectedIcon }) => {
    useEffect(() => {
        if (!selectedIcon) {
